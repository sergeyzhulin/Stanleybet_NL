 ...
 */
public class MatchesDetails extends DbModel {
...
//    public int type;
    ...
    private MatchesDetails(long _id) {
        id = _id;
    }

    public static MatchesDetails newInstance(Cursor c) {

        MatchesDetails leagues = new MatchesDetails(AppCursor.getLong(c, Columns.SPORT_ID));
    ...
    public static MatchesDetails newInstance(long id, String name, JSONObject jsonObject) throws JSONException {
        MatchesDetails leagues = new MatchesDetails(id);
    ...
    public static MatchesDetails newInstance(long id, JSONObject jsonObject) throws JSONException {
        MatchesDetails country = new MatchesDetails(id);
        //leagues.imageUrl = imageUrl;
        //leagues.imageMapUrl = imageMapUrl;
        //leagues.lang = AppJson.getString(jsonObject, "lang");
        country.name = AppJson.getString(jsonObject, "ItemName");
    ...
    public static ArrayList<MatchesDetails> getSports(JSONArray jsonArray) throws JSONException {
        ...
        ArrayList<MatchesDetails> leagueses = new ArrayList<MatchesDetails>();

        for (long i = 0; i < jsonArray.length(); i++) {
            leagueses.add(MatchesDetails.newInstance(i, jsonArray.getJSONObject((int) i)));
        }
        return leagueses;
    }
    ...
    public static final void getCreatedScript(SQLiteDatabase db, Context context) {
        db.execSQL("CREATE TABLE IF NOT EXISTS " + MatchesDetails.TABLE_NAME + "(" +
...
//                Columns.TYPE + " INTEGER" +
    ...
    public static final Creator<MatchesDetails> CREATOR = new Creator<MatchesDetails>() {
        public MatchesDetails createFromParcel(Parcel p) {
            return new MatchesDetails(p);
        }

        public MatchesDetails[] newArray(int size) {
            return new MatchesDetails[size];
        }
    };

    public MatchesDetails(Parcel p) {
