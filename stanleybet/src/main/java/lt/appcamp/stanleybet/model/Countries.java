 ...
 */
public class Countries extends DbModel {
...
//    public int type;
    ...
    private Countries(long _id) {
        id = _id;
    }

    public static Countries newInstance(Cursor c) {

        Countries leagues = new Countries(AppCursor.getLong(c, Columns.SPORT_ID));
    ...
    public static Countries newInstance(long id, String name, JSONObject jsonObject) throws JSONException {
        Countries leagues = new Countries(id);
    ...
    public static Countries newInstance(long id, JSONObject jsonObject) throws JSONException {
    ...
    public static ArrayList<Countries> getSports(JSONArray jsonArray) throws JSONException {
        ...
        ArrayList<Countries> leagueses = new ArrayList<Countries>();

        for (long i = 0; i < jsonArray.length(); i++) {
            leagueses.add(Countries.newInstance(i, jsonArray.getJSONObject((int) i)));
        }
        return leagueses;
    }
